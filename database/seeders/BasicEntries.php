	...
	public function run()
		...
		*/
		...
		DB::table('item_properties')->insert([
			...
			['name' => 'DAMAGE_EARTH_GUARDIAN', 'description' => 'This weapon can damage the Earth Guardian.', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
			['name' => 'DAMAGE_AIR_GUARDIAN', 'description' => 'This weapon can damage the Air Guardian.', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
		...
		*/
		...
		DB::table('item_properties')->insert([
			...
			['name' => 'DAMAGE_EARTH_GUARDIAN', 'description' => 'This weapon can damage the Earth Guardian.', 'format' => '{}', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
			['name' => 'DAMAGE_AIR_GUARDIAN', 'description' => 'This weapon can damage the Air Guardian.', 'format' => '{}', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
			['name' => 'DAMAGE_FIRE_GUARDIAN', 'description' => 'This weapon can damage the Fire Guardian.', 'format' => '{}', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
			['name' => 'DAMAGE_WATER_GUARDIAN', 'description' => 'This weapon can damage the Water Guardian.', 'format' => '{}', 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
