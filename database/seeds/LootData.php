...
class LootData extends Seeder
	{
		...
		*/
		...
		DB::table('loot_tables')->insert([
			...
			['creatures_id' => 7, 'items_id' => 164, 'chance' => 0.9, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
			['creatures_id' => 7, 'items_id' => 165, 'chance' => 0.9, 'created_at' => date("Y-m-d H:i:s"), 'updated_at' => date("Y-m-d H:i:s")],
		]);
		}
	}
